  ...
  : AnytoneRadio("BTECH DMR-6X2UV", device, parent), _limits(nullptr)
{
  ...
  case 0x03:
    ...
    break;
  case 0x04:
    _limits = new DMR6X2UVLimits({ {144., 146.}, {434., 438.} },
                                 { {144., 146.}, {434., 438.} }, info.version, this);
    break;
  case 0x05:
    _limits = new DMR6X2UVLimits({ {144., 146.}, {434., 437.} },
  ...
  case 0x0a:
    ...
    break;
  case 0x0b:
    _limits = new DMR6X2UVLimits({ {136., 174.}, {400., 520.} },
                                 { {136., 174.}, {400., 520.} }, info.version, this);
    break;
  case 0x0c:
    _limits = new DMR6X2UVLimits({ {136., 174.}, {400., 490.} },
  ...
  case 0x0d:
    ...
    break;
  case 0x0e:
    _limits = new DMR6X2UVLimits({ {136., 174.}, {220.,225.}, {400., 520.} },
                                 { {136., 174.}, {220.,225.}, {400., 520.} }, info.version, this);
    break;
  case 0x0f:
    _limits = new DMR6X2UVLimits({ {144., 148.}, {420., 520.} },
                                 { {144., 148.}, {420., 520.} }, info.version, this);
    break;
  case 0x10:
    _limits = new DMR6X2UVLimits({ {144., 147.}, {430., 440.} },
