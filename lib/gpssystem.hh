...
public:
  ...
  static const uint TABLE_MASK      = SECONDARY_TABLE;
  typedef enum {
    ...
    APRS_ICON_FIRE, APRS_ICON_CAMPGROUND, APRS_ICON_BOY_MOTORCYCLE, APRS_ICON_RAIL_ENGINE,
    ...
    APRS_ICON_TRIANGLE, APRS_ICON_PBBS, APRS_ICON_PLANE_LARGE, APRS_ICON_WC_STN, APRS_ICON_DISH_ANT,
