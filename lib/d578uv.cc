  ...
  : AnytoneRadio("Anytone AT-D578UV", device, parent), _limits(nullptr)
{
  ...
  case 0x04:
    ...
    break;
  case 0x05:
    _limits = new D578UVLimits({ {144., 146.}, {434., 447.} },
                               { {144., 146.}, {434., 447.} }, info.version, this);
    break;
  case 0x06:
    _limits = new D578UVLimits({ {136., 174.}, {446., 447.} },
  ...
  case 0x07:
    ...
    break;
  case 0x08:
    _limits = new D578UVLimits({ {136., 174.}, {400., 470.} },
                               { {136., 174.}, {400., 470.} }, info.version, this);
    break;
  case 0x09:
    _limits = new D578UVLimits({ {144., 146.}, {430., 432.} },
  ...
  case 0x0a:
    ...
    break;
  case 0x0b:
    _limits = new D578UVLimits({ {136., 174.}, {400., 520.} },
                               { {136., 174.}, {400., 520.} }, info.version, this);
    break;
  case 0x0c:
    _limits = new D578UVLimits({ {136., 174.}, {400., 490.} },
  ...
  case 0x0d:
    ...
    break;
  case 0x0e:
    _limits = new D578UVLimits({ {136., 174.}, {220.,225.}, {400., 520.} },
                               { {136., 174.}, {220.,225.}, {400., 520.} }, info.version, this);
    break;
  case 0x0f:
    _limits = new D578UVLimits({ {144., 148.}, {420., 520.} },
                               { {144., 148.}, {420., 520.} }, info.version, this);
    break;
  case 0x10:
    _limits = new D578UVLimits({ {144., 147.}, {430., 440.} },
  ...
  case 0x11:
    ...
    break;
  case 0x12:
    _limits = new D578UVLimits({ {136., 174.}, {220.,225.}, {400., 480.} },
                               { {144., 148.}, {222.,225.}, {420., 450.} }, info.version, this);
    break;
  default:
