...
D868UV::D868UV(AnytoneInterface *device, QObject *parent)
  : AnytoneRadio("Anytone AT-D868UV", device, parent), _features(_d868uv_features), _limits(nullptr)
{
  ...
  case 0x0c:
    ...
    _limits = new D868UVLimits({ {136., 174.}, {403., 470.} }, this);
    break;
